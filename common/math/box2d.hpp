...
public:
   ...
   */
  virtual double area() const { return length_ * width_; }
   ...
   */
  virtual void GetAllCorners(std::vector<Vec2d> *const corners) const;

  /**
   * @brief Getter of the corners of the box
   * @param corners The vector where the corners are listed
   */
  virtual std::vector<Vec2d> GetAllCorners() const;
   ...
   */
  virtual bool IsPointIn(const Vec2d &point) const;
   ...
   */
  virtual bool IsPointOnBoundary(const Vec2d &point) const;
   ...
   * @return A distance
   */
  virtual double DistanceTo(const Vec2d &point) const;
   ...
   * @return A distance
   */
  virtual double DistanceTo(const LineSegment2d &line_segment) const;
   ...
   * @return A distance
   */
  virtual double DistanceTo(const Box2d &box) const;
   ...
   */
  virtual bool HasOverlap(const LineSegment2d &line_segment) const;
  ...
  virtual void InitCorners();

  virtual double max_x() const { return max_x_; }
  virtual double min_x() const { return min_x_; }
  virtual double max_y() const { return max_y_; }
  virtual double min_y() const { return min_y_; }
